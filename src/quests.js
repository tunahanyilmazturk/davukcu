...
export const QUESTS = [
  ...
  { name: 'Bant Zamanı',       desc: 'Depolama Bandını hızlandır',              prog: () => [S.lvl.beltD, 1],       reward: 60 },
  { name: 'Yukarıdan Aşağı',   desc: 'Çiftlik Bandını hızlandır',               prog: () => [S.lvl.beltF, 1],       reward: 80 },
